...
- [x] rank: 8 (小模型) / 16 (大模型), 32 通常没必要
- [x] alpha: = rank 或 2x rank
- [x] target_modules: ["q_proj", "v_proj"] 最少,加更多更好
- [x] dropout: 0.05-0.1
