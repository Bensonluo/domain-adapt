...
|---|---|---|---|---|---|
| P1-C01 | 已完成 1B–3B token CPT | Week 10 管线；约 1414 万 token 真实语料 | 与目标规模差两个数量级；早期检查项互相矛盾 | RETRACTED | CPT 数据管线和小规模真实语料实验已完成 |
...
| P1-C13 | 合成数据质量已完成临床/人工验证 | Week 21 AI 非临床复核 30 条 | 不是人类或临床审阅 | RETRACTED | 完成了 30 条 AI 非临床 sanity check |

## 阅读说明

本表对照早期结论、实验依据和修订后的解释。状态标签描述具体结论的证据情况，而非交付完成度：观察到的趋势、尚未回答的问题和修正过程都属于阶段总结的内容。各条目的数据、配置与后续思考见对应周记录。
